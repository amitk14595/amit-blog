...
• Introduction to Campus Network Diagram
...
**Quality of Service:-**
**Unit 1: Introduction to QoS**
• Introduction to QoS
• IP Precedence and DSCP Values
• How to configure Classification
• How to configure Marking
• LLQ (Low Latency Queuing)
• CBWFQ on Sub-Interfaces
**Unit 2: LAN QoS**
• QoS on LAN Switches
• QoS Trust Boundary
• Classification and Marking on Switch
• Queuing on 3560/3750 Switches
**Unit 3 : Shaping**
• Introduction to Shaping
• How to configure Shaping
• Shaping with burst up to interface bandwidth
• Peak Traffic Shaping Configuration
• Frame-relay shaping configuration
• How to test if your ISP shapes your traffic.
**Unit 4 : Policing**
• Introduction to Policing
• How to configure Policing
**Unit 5: RSVP**
• Introduction to RSVP
• RSVP DSBM
**Unit 6: Miscellaneous**
• IP SLA Traffic Generator
• Introduction to NBAR
